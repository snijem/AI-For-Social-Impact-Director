...
// Startup check - only log if key is missing
if (!process.env.LUMA_API_KEY && process.env.NODE_ENV === 'development') {
  console.warn('[Luma API Route] LUMA_API_KEY not found in environment');
}
...
export async function POST(req) {
  try {
    ...
    // Environment check (only log errors)
    ...
    console.error("[Luma API] Error generating video:", error.message);
