...
export function buildContextualPrompt(storyContext, sceneDescription, sceneIndex, isContinuation = false) {
  ...
  prompt += `${sceneDescription}. Bright colors, clean animation style, educational and inspiring. Single continuous shot, stable scene, realistic motion, no glitches, no fast movement, no scene cuts.`
